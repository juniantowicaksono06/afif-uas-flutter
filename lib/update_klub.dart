...
class UpdateKlub extends StatefulWidget {
  String id_klub;
  UpdateKlub({
    super.key,
 ...
 @override
  _UpdateKlub createState() => _UpdateKlub();
}

class _UpdateKlub extends State<UpdateKlub> {
  ...
  void initState() {
    ...
    super.initState();
    _idKlubController.text = widget.id_klub;
    _getData();
  }
  ...
  void _getData() async {
      ...
      final response = await http.get(
        Uri.parse(dotenv.env['API_BASE_URL']! + "/klub-sepakbola?search=id_klub&value=${widget.id_klub}")
      ...
      if(await response.statusCode == 200) {
        setState(() {
          _namaController.text = responseData['nama_klub'];
          _tglBerdiri = DateTime.parse(responseData['tgl_berdiri']);
          _kondisiKlub = responseData['kondisi_klub'];
          _kotaController.text = responseData['kota_klub'];
          _peringkat = responseData['peringkat'].toString();
          print(_peringkat);
          _hargaController.text = responseData['harga_klub'].toString();
        });
      }
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: 
              const Text("Tanggal Berdiri", style: TextStyle(
